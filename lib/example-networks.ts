...
export const EXAMPLE_NETWORKS_METADATA: ExampleNetworkMetadata[] = [
  ...
  { name: "SENet", filename: "SENet_Full.json" },
  { name: "GPT2-full", filename: "GPT2-full.json" },
  { name: "LSTM-Node", filename: "LSTM-Node.json" },
  { name: "MultiheadAttention (White-Box)", filename: "MultiheadAttention_whitebox.json" },
  ...
  { name: "MobileNetV1", filename: "MobileNetV1_standard.json" },
  { name: "MobileNetV2", filename: "MobileNetV2_full.json" },
  ...
  { name: "StyleGAN", filename: "StyleGAN.json" },
  { name: "StyleGAN-Generator", filename: "StyleGAN-Generator.json" },
  { name: "StyleGAN-Discriminator", filename: "StyleGAN-Discriminator.json" },
  ...
  { name: "AlexNet (Two Streams)", filename: "AlexNet_Two_Streams.json" },
